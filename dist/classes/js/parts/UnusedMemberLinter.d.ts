...
export declare class UnusedMemberLinter<Parser extends AbstractUI5Parser<CustomClass>, CustomClass extends AbstractCustomClass> extends JSLinter<Parser, CustomClass> {
    protected className: JSLinters;
    protected _getErrors(document: TextDocument): IError[];
    private _checkIfMemberIsUsed;
    private _checkIfMethodIsException;
